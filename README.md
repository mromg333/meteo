...
Οι τιμές αυτές καταχωρήθηκαν τόσο σε ετήσια όσο και σε μηνιαία βάση, επιτρέποντας τη λεπτομερή παρακολούθηση της ψυχρής περιόδου μέσα στον χρόνο [^1].

 
 ![image2](images/Chilling_Hours_Monthly_New.png)
 
 ![image3](images/Chill_Yearly.png)
<br>Με βάση τις μετρήσεις του ψύχους που καταγράφηκαν στην περιοχή της Λάρισας μπορούμε να τις ταξινομήσουμε με 3 ποικιλές ροδάκινων και να διαπιστώσουμε εάν είναι εύκρατες σε αυτή την περιοχή βασιμένη πάνω σε εγκύρες πηγές</br>
| Ποικολίες Ροδάκινων  | Ώρες Ψύχους (0-7,2°C) |
|-----------|------------------------|----------|
| Maria Bianca   | 611                    |
| Honey Dew Hale  | 611                    |
| Red Haven  | 611                    |
