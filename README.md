 ...
 * η θερμοκρασία
 * η υγρασία του αέρα και του εδάφους
...
απόκλιση της θερμοκρασίας από την ιδανική τιμή των 20°C, σε συνδυασμό με την ένταση του ανέμου. 
...
Για τη σπορά, θεωρούνται κατάλληλες οι ημέρες όταν η υγρασία εδάφους κυμαίνεται μεταξύ 40% και 75%, η θερμοκρασία είναι μεταξύ 10°C και 28°C, και η υγρασία του αέρα ξεπερνά το 35%.

Αντίστοιχα, για τον ψεκασμό, η υγρασία εδάφους πρέπει να είναι κάτω από 70%, η ταχύτητα του ανέμου μικρότερη από 6 m/s, και η υγρασία του αέρα πάνω από 35%.
