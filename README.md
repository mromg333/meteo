...
## Προβλέψεις για Σπορά και Ψεκασμό
 Με τη βοήθεια μελλοντικών προβλέψεων για  τις μετρήσεις της θερμοκρασίας, ταχύτητας ανέμου, σχετικής υγρασίας και βροχόπτωσης μπορούμε να καθορίσουμε τις κατάλληλες ώρες που μπορεί να πραγματοποιηθεί η Σπόρα και Ο Ψεκασμός. Συγκεκριμένα για κάθε μία από τις εικονιζόμενες ποικιλίες ροδακινιών υπολογίζεται η υγρασία του εδάφους από των παρακάτω τύπο. Για κάθε ποικιλία χρησιμοποιήθηκαν λογικές αποδοχές δηλαδή μετρήσεις που δείχνουν τις κατάλληλες συνθήκες του εδάφους στις οποίες μπορεί πραγματοποιηθεί αποδοτικός Ψεκασμός και Σπορά

 $$
\Delta S = P - E
$$
- **\Delta S**:Μεταβολή της υγρασίας του εδάφους (mm),
- **P**:Βροχόπτωση (mm),
