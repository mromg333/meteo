 ...
 * Προβλέψεις σχετικά με την καταλληλότητα του εδάφους στις αγροκαλλιέργιες
...
- **PET**: Δυνητική εξατμισοδιαπνοή σε χιλιοστά (mm),
- **0.408**: Συντελεστής μετατροπής από W/m² σε mm,
- **Rₛ**: Ηλιακή ακτινοβολία σε W/m² ανά ημέρα.
