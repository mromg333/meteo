...
από τα οποία εξάγονται δείκτες που χαρακτηρίζουν τη βιωσιμότητα των καλλιεργειών.
 ...
 * Τη συσσώρευση βλάστησης στις καλλιέργειες  (GDD & PET)
 ...
 *Τη καταλληλότητα του εδάφους για τη καλλιέργεια ροδάκινων σχετικά με:
 ...
 1) Τη συσσώρευση βλάστησης στις καλλιέργειες  (GDD & PET)
 2) Τη ..
...
Χρησιμοποιώντας τα πρωτογενή δεδομένα εφαρμόσαμε το τύπο του δείκτη δυσφορίας ( Discomfort Index), έναν αριθμητικό δείκτη που μας δείχνει βάση της υγρασίας και της θερμοκρασίας, πόσο ενοχλητική είναι ζέστη για το σώμα μας.
