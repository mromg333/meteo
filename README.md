...
## PET Predictions
![image10](images/pet_pred.png)                                                     Σε αυτό  το σημείο Θα θέλαμε να εκφράσουμε τις θερμές μας ευχαριστίες στον επιβλέποντα καθηγητή μας, κ. Χαραλάαμπους Ονούφριο , για την πολύτιμη καθοδήγηση, την υποστήριξη και τις χρήσιμες παρατηρήσεις του καθ’ όλη τη διάρκεια της εκπόνησης της παρούσας εργασίας καθώς και για την παροχή  των μετεωρολογικών  δεδομένων.                 Η εργασία αυτή συντάχθηκε από τους φοιτητές Τζιβελίδης Βαλέριος και Χατζηνικολάου Δημήτριος.
### Βιβλιογραφία
