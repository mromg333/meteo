...
Τελικός στόχος της εργασίας είναι να εξετάσει πώς αυτές οι μετρήσεις μπορούν να χρησιμοποιηθούν για τη δημιουργία συνθηκών που αφορούν το κλίμα και τις καλλιέργιες
 * Ώρες Ψύχους
