...
Συγκεκριμένα, για κάθε μία από τις εικονιζόμενες ποικιλίες ροδακινιών υπολογίζεται η υγρασία του εδάφους με βάση τον παρακάτω τύπο FAO-56 Penman-Monteith:
...
Από αυτόν τον [τύπο του PET](#Συσσώρευση-Βλάστησης), λόγω έλλειψης τιμών, χρησιμοποιήσαμε 
