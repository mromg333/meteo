...
Με βάση τις μετρήσεις του ψύχους που καταγράφηκαν στην περιοχή της Λάρισας μπορούμε να τις ταξινομήσουμε με 3 ποικιλές ροδάκινων και να προβλέψουμε εάν είναι εύκρατες σε αυτή την περιοχή.
| Περιοχή   | Ώρες Ψύχους (0-7,2°C) |
|-----------|------------------------|
| Λάρισα    | 611                    |
