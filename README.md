...
* Τη  μελλοντική μεταβολή  της υγρασίας του εδάφους σχετικά με το PET για να πραγματοποιηθεί η σπορά και ο ψεκασμός των ροδάκινων
* Τη  μελλοντική μεταβολή του PET σχετικά με την καταλληλότητα του εδάφους γι
