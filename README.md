...
Η παρακολούθηση του PET βοηθά γεωπόνους και αγρότες να προγραμματίζουν σωστά την άρδευση, αποφεύγοντας τόσο την υπερβολική όσο και την ανεπαρκή παροχή νερού. Υπολογίζεται με βάση κλιματικά δεδομένα, όπως η θερμοκρασία, η ηλιακή ακτινοβολία, η υγρασία, ο άνεμος και το βαρομετρικό υψόμετρο. Ο παρακάτω τύπος υλοποιήθηκε με τη βιβλιοθήκη Pyeto.



$$
PET= \frac{0.408 \, \Delta (R_n - G) + \gamma \, \frac{900}{T + 273} \, u_2 \, (e_s - e_a)}{\Delta + \gamma \, (1 + 0.34 \, u_2)} , FAO-56 Penman-Monteith
$$
...
* Νumpy , για τον υπολογισμό σύνθετων τιμών 
